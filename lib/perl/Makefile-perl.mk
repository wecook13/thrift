...
VERSION_SYM = 1_0_0_dev
DEFINE_VERSION = -D$(VERSION_MACRO)=\"$(VERSION)\"
XS_VERSION = 1.0.0-dev
...
PM_TO_BLIB = lib/Thrift/Server.pm \
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'version:            1.0.0-dev' >> META_new.yml
...
ppd :
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="1.0.0-dev">' > $(DISTNAME).ppd
