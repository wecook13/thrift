...
{
  int32_t cseqid = 0;
  this->oprot_->writeMessageBegin("onewayWait", ::apache::thrift::protocol::T_CALL, cseqid);
...
template <class Protocol_>
::boost::shared_ptr< ::apache::thrift::TProcessor > ParentServiceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ParentServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< ParentServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new ParentServiceProcessorT<Protocol_>(handler));
  return processor;
}
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::incrementGeneration(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_incrementGeneration();
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getGeneration(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_getGeneration();
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::addString(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& s)
{
  send_addString(s);
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getStrings(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_getStrings();
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::getDataWait(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const int32_t length)
{
  send_getDataWait(length);
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::onewayWait(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob)
{
  send_onewayWait();
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::exceptionWait(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message)
{
  send_exceptionWait(message);
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceCobClientT<Protocol_>::unexpectedExceptionWait(tcxx::function<void(ParentServiceCobClientT<Protocol_>* client)> cob, const std::string& message)
{
  send_unexpectedExceptionWait(message);
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::dispatchCall(tcxx::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::dispatchCallTemplated(tcxx::function<void(bool ok)> cob, Protocol_* iprot, Protocol_* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    iprot->skip(::apache::thrift::protocol::T_STRUCT);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_incrementGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_incrementGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_incrementGeneration_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration;
  iface_->incrementGeneration(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1));
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_incrementGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ParentService_incrementGeneration_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getGeneration_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getGeneration(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ParentService_getGeneration_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_addString(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_addString(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_addString(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_addString_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_addString;
  iface_->addString(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx),
      args.s);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_addString(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_addString_presult result;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getStrings(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getStrings(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::vector<std::string> & _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getStrings(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getStrings_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<std::string> & _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_getStrings;
  iface_->getStrings(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1));
}
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getStrings(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::vector<std::string> & _return)
{
  ParentService_getStrings_presult result;
  result.success = const_cast<std::vector<std::string> *>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getDataWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const std::string& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_getDataWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_getDataWait_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait;
  iface_->getDataWait(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1),
      args.length);
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_getDataWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const std::string& _return)
{
  ParentService_getDataWait_presult result;
  result.success = const_cast<std::string*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_onewayWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  freer.unregister();
  iface_->onewayWait(tcxx::bind(cob, true)
);
}

template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_onewayWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  (void) seqid;
  (void) oprot;
  ParentService_onewayWait_args args;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
  ...
  void (ParentServiceAsyncProcessorT<Protocol_>::*throw_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_exceptionWait_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  void (ParentServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx) =
    &ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait;
  void (ParentServiceAsyncProcessorT<Protocol_>::*throw_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw) =
    &ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait;
  iface_->exceptionWait(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx),
      tcxx::bind(throw_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1),
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_exceptionWait_presult result;
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::throw_exceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, ::apache::thrift::TDelayedException* _throw)
{
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_unexpectedExceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_unexpectedExceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::process_unexpectedExceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ParentService_unexpectedExceptionWait_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
template <class Protocol_>
void ParentServiceAsyncProcessorT<Protocol_>::return_unexpectedExceptionWait(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx)
{
  ParentService_unexpectedExceptionWait_presult result;
...
template <class Protocol_>
::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > ParentServiceAsyncProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ParentServiceCobSvIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< ParentServiceCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new ParentServiceAsyncProcessorT<Protocol_>(handler));
  return processor;
}
}}} // namespace
