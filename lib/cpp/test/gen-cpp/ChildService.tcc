...
template <class Protocol_>
::boost::shared_ptr< ::apache::thrift::TProcessor > ChildServiceProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ChildServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< ChildServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new ChildServiceProcessorT<Protocol_>(handler));
  return processor;
}
template <class Protocol_>
void ChildServiceCobClientT<Protocol_>::setValue(tcxx::function<void(ChildServiceCobClientT<Protocol_>* client)> cob, const int32_t value)
{
  send_setValue(value);
...
template <class Protocol_>
void ChildServiceCobClientT<Protocol_>::getValue(tcxx::function<void(ChildServiceCobClientT<Protocol_>* client)> cob)
{
  send_getValue();
  this->channel_->sendAndRecvMessage(tcxx::bind(cob, this), this->otrans_.get(), this->itrans_.get());
}
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::dispatchCall(tcxx::function<void(bool ok)> cob, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::dispatchCallTemplated(tcxx::function<void(bool ok)> cob, Protocol_* iprot, Protocol_* oprot, const std::string& fname, int32_t seqid) {
  typename ProcessMap::iterator pfn;
  pfn = processMap_.find(fname);
  if (pfn == processMap_.end()) {
    return ParentServiceAsyncProcessorT<Protocol_>::dispatchCall(cob, iprot, oprot, fname, seqid);
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::process_setValue(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  ...
  freer.unregister();
  void (ChildServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return) =
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::return_setValue(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::process_setValue(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ChildService_setValue_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
  ...
  freer.unregister();
  void (ChildServiceAsyncProcessorT<Protocol_>::*return_fn)(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return) =
    &ChildServiceAsyncProcessorT<Protocol_>::return_setValue;
  iface_->setValue(
      tcxx::bind(return_fn, this, cob, seqid, oprot, ctx, tcxx::placeholders::_1),
      args.value);
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::return_setValue(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ChildService_setValue_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::process_getValue(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot)
{
  Protocol_* _iprot = dynamic_cast<Protocol_*>(iprot);
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_iprot && _oprot) {
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::return_getValue(tcxx::function<void(bool ok)> cob, int32_t seqid, ::apache::thrift::protocol::TProtocol* oprot, void* ctx, const int32_t& _return)
{
  Protocol_* _oprot = dynamic_cast<Protocol_*>(oprot);
  if (_oprot) {
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::process_getValue(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* iprot, Protocol_* oprot)
{
  ChildService_getValue_args args;
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
...
template <class Protocol_>
void ChildServiceAsyncProcessorT<Protocol_>::return_getValue(tcxx::function<void(bool ok)> cob, int32_t seqid, Protocol_* oprot, void* ctx, const int32_t& _return)
{
  ChildService_getValue_presult result;
  result.success = const_cast<int32_t*>(&_return);
  result.__isset.success = true;
...
template <class Protocol_>
::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > ChildServiceAsyncProcessorFactoryT<Protocol_>::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ChildServiceCobSvIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< ChildServiceCobSvIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::async::TAsyncProcessor > processor(new ChildServiceAsyncProcessorT<Protocol_>(handler));
  return processor;
}
}}} // namespace
