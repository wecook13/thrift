...
::boost::shared_ptr< ::apache::thrift::TProcessor > ReverseOrderServiceProcessorFactory::getProcessor(const ::apache::thrift::TConnectionInfo& connInfo) {
  ::apache::thrift::ReleaseHandler< ReverseOrderServiceIfFactory > cleanup(handlerFactory_);
  ::boost::shared_ptr< ReverseOrderServiceIf > handler(handlerFactory_->getHandler(connInfo), cleanup);
  ::boost::shared_ptr< ::apache::thrift::TProcessor > processor(new ReverseOrderServiceProcessor(handler));
  return processor;
}
}}} // namespace
