...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = i386-apple-darwin12.5.0
host_triplet = i386-apple-darwin12.5.0
am__append_1 = test
subdir = .
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	$(srcdir)/Makefile.in $(srcdir)/config.hin \
	$(top_srcdir)/compiler/cpp/src/windows/version.h.in \
...
CONFIG_HEADER = config.h $(top_builddir)/lib/cpp/src/thrift/config.h
CONFIG_CLEAN_FILES = compiler/cpp/src/windows/version.h
...
ACLOCAL = ${SHELL} /Users/bohu/thrift/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /Users/bohu/thrift/missing --run tar
ANT = /usr/bin/ant
ANT_FLAGS = 
AR = ar
AUTOCONF = ${SHELL} /Users/bohu/thrift/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/bohu/thrift/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/bohu/thrift/missing --run automake-1.11
AWK = awk
BOOST_CPPFLAGS = -I/opt/local/include
BOOST_LDFLAGS = -L/opt/local/lib
BOOST_ROOT_PATH = /opt/local
BUNDLER = /Users/bohu/.rvm/gems/ruby-2.0.0-p247/bin/bundle
CABAL = true
...
LIBEVENT_CPPFLAGS = -I/opt/local/include
LIBEVENT_LDFLAGS = -L/opt/local/lib
...
MAKEINFO = ${SHELL} /Users/bohu/thrift/missing --run makeinfo
MANIFEST_TOOL = :
...
QT_LIBS = 
QT_MOC = 
RAKE = /Users/bohu/.rvm/gems/ruby-2.0.0-p247@global/bin/rake
RANLIB = ranlib
RUBY = /Users/bohu/.rvm/rubies/ruby-2.0.0-p247/bin/ruby
RUBY_PREFIX = 
RUNHASKELL = true
SED = /usr/bin/sed
SET_MAKE = 
...
ZLIB_LDFLAGS = 
ZLIB_LIBS = -lz
abs_builddir = /Users/bohu/thrift
abs_srcdir = /Users/bohu/thrift
abs_top_builddir = /Users/bohu/thrift
abs_top_srcdir = /Users/bohu/thrift
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /Users/bohu/thrift/install-sh
...
lib/cpp/src/thrift/config.h: lib/cpp/src/thrift/stamp-h2
	@if test ! -f $@; then \
	  rm -f lib/cpp/src/thrift/stamp-h2; \
	  $(MAKE) $(AM_MAKEFLAGS) lib/cpp/src/thrift/stamp-h2; \
	else :; fi

lib/cpp/src/thrift/stamp-h2: $(srcdir)/config.hin $(top_builddir)/config.status
	@rm -f lib/cpp/src/thrift/stamp-h2
	cd $(top_builddir) && $(SHELL) ./config.status lib/cpp/src/thrift/config.h

distclean-hdr:
	-rm -f config.h stamp-h1 lib/cpp/src/thrift/config.h lib/cpp/src/thrift/stamp-h2
compiler/cpp/src/windows/version.h: $(top_builddir)/config.status $(top_srcdir)/compiler/cpp/src/windows/version.h.in
...
TAGS: tags-recursive $(HEADERS) $(SOURCES) config.hin config.hin $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	set x; \
	here=`pwd`; \
	...
	list='$(SOURCES) $(HEADERS) config.hin config.hin $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
	  done | \
	  $(AWK) '{ files[$$0] = 1; nonempty = 1; } \
...
ctags: CTAGS
CTAGS: ctags-recursive $(HEADERS) $(SOURCES) config.hin config.hin $(TAGS_DEPENDENCIES) \
		$(TAGS_FILES) $(LISP)
	list='$(SOURCES) $(HEADERS) config.hin config.hin $(LISP) $(TAGS_FILES)'; \
	unique=`for i in $$list; do \
	    if test -f "$$i"; then echo $$i; else echo $(srcdir)/$$i; fi; \
